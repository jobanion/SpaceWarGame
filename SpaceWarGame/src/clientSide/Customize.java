...
//		}
	...
	public void apply() {
		...
		//System.out.println(Menu.userName + "|" + Menu.password + "|" + SpaceGame.shipName1.substring(9, 10));
		SendInfo(Menu.userName + "|" + Menu.password + "|" + SpaceGame.shipName1.substring(9, 10), 2);
